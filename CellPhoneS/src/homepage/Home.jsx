...
import pic8 from "../assets/Homepage/pic8.jpg"
// data
...
//
const screenwidth = window.innerWidth > 640 ? 805 : 359;
const Home = () =>{
        ...
        <div className={style.ctn}>
          <div className={style.head}>
            ...
            <div className={style.middle}>
              ...
              <div className={style.btn_ctn_m}>
                <button
                  className={`${style.m_btn} ${
